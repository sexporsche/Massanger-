...
public final class DepartmentDao_Impl implements DepartmentDao {
  ...
  public DepartmentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDepartmentEntity = new EntityInsertionAdapter<DepartmentEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `departments` (`id`,`name`) VALUES (?,?)";
      }
  ...
  @Override
  public Object insertAll(final List<DepartmentEntity> departments,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfDepartmentEntity.insert(departments);
  ...
  @Override
  public Flow<List<DepartmentEntity>> observeDepartments() {
    final String _sql = "SELECT * FROM departments ORDER BY name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
      ...
      public List<DepartmentEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new DepartmentEntity(_tmpId,_tmpName);
            _result.add(_item);
          }
          return _result;
        } finally {
