...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull FrameLayout rootView, @NonNull TextView tvDeliveryStatus,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((FrameLayout) rootView, tvDeliveryStatus, tvMessageText,
          tvMessageTime);
    }
